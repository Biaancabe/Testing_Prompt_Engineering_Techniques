...
llm_generated_medications = ["Methotrexate", "MTX", "Cyclosporine", "CSA", "Acitretin", "Anthralin cream", "Salicylic acid",
                            "Coal tar", "Tacrolimus ointment", "UVB phototherapy", "etanercept", "adalimumab", "infliximab"]

...
llm_generated_medications = ["Oxaliplatin", "Irinotecan", "Fluorouracil", "Cetuximab", "Leucovorin", "Bevacizumab",
              "Docetaxel", "Sutent", "Erlotinib", "Panitumumab", "Camptothecins", "Nexavar", "Avastin",
              "Zaltrap", "Xalkori", "Alimta", "Vemurafenib", "Opdivo", "Keytruda"]

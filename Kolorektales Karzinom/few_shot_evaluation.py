...
llm_generated_medications = ["Oxaliplatin", "Eloxatin", "Irinotecan", "Camptosar", "Fluorouracil", "Cetuximab", "Erbitux", "Leucovorin", "folic acid", "Bevacizumab",
                             "Avastin", "Docetaxel", "Taxotere", "Sutent", "Sunitinib", "Erlotinib", "Tarceva", "Panitumumab", "Vectibix", "Camptothecins",
                             "Nexavar", "sorafenib", "Avastin", "bevacizumab", "Zaltrap", "Ziv-Edgars", "Xalkori", "crizotinib", "Alimta", "pemetrexed",
                             "Vemurafenib", "Zelboraf", "Opdivo", "nivolumab", "Keytruda", "pembrolizumab"
]

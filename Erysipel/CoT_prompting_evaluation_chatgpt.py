...
llm_generated_medications = ["Topical antibiotics", "mupirocin", "bacitracin", "Antivirals", "acyclovir",
              "Antifungal creams", "clotrimazole", "Antihistamines", "diphenhydramine", "Oral steroids",
              "prednisone", "Nonsteroidal anti-inflammatories", "NSAIDs", "ibuprofen", "Acetaminophen",
              "Tylenol", "HY Chat Doctor"]

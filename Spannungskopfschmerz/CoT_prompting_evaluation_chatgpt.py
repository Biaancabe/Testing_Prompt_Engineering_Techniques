...
llm_generated_medications = ["Acetaminophen", "ibuprofen", "naproxen", "ketorolac", "diclofenac", "oxycodone",
              "hydrocodone", "codeine", "carisoprodol", "cyclobenzaprine", "amitriptyline",
              "nortriptyline", "gabapentin", "pregabalin"]

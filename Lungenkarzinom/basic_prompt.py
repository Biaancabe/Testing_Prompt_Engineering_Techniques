...
llm_generated_medications = ["Gefitinib", "Erlotinib", "Cisplatin", "Carboplatin", "Gemcitabine", "Vinorelbine",
              "Pemetrexed", "Docetaxel", "Camptothecin", "Topotecan", "Nab-paclitaxel", "Alimta", "Tarceva",
              "Taxol", "Etoposide", "Doxorubicin", "Mitoxantrone", "Thalidomide", "Denileukin diftitox",
              "Bortezomib", "Bevacizumab", "Cetuximab", "Panitumumab", "Ziv-aflibercept"]

#llm_generated_medications = ["cisplatin", "carboplatin", "etoposide", "bleomycin + ifosfamide", "paclitaxel", "docetaxel", "irinotecan", "oxaliplatin"]

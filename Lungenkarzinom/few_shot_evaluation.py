...
llm_generated_medications = ["Gefitinib2", "Erlotinib", "Cisplatin", "Carboplatin", "Gemcitabine", "Vinorelbine", "Pemetrexed",
                             "Docetaxel", "Camptothecin", "Topotecan", "Nab-paclitaxel", "Alimta", "Tarceva", "Taxol", "Etoposide",
                             "Doxorubicin", "Mitoxantrone", "Thalidomide", "Denileukin diftitox", "Bortezomib", "Bevacizumab",
                             "Cetuximab", "Panitumumab", "Ziv-aflibercept"]
